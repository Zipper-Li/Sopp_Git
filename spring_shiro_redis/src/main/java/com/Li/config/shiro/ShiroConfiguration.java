...
import com.Li.common.exception.GlobalExceptionHandler;
 ...
 * @Description: Shiro核心配置，项目启动会被加载
 * @author: LiDa
 * @date: 2018年8月17日 下午6:29:39 注意：本内容仅限于个人学习，禁止外泄以及用于其他的商业项目
 */
@Configuration
@Order(1)
public class ShiroConfiguration {
	...
	// 注入异常处理类
	@Bean
	public GlobalExceptionHandler myExceptionResolver() {
